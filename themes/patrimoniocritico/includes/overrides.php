...
namespace PatrimonioCritico\Overrides;
...
function setup() {
	...
	add_filter( 'tiny_mce_plugins', 'PatrimonioCritico\Overrides\disable_emojis_tinymce' );
	add_filter( 'wp_resource_hints', 'PatrimonioCritico\Overrides\disable_emoji_dns_prefetch', 10, 2 );
